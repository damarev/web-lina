...
<div class="flex gap-5 my-6">
    <div class="w-[68%]">
        <img src="/img/proyectos/antifemina/2-antifemina.jpg" alt="">
    </div>
    <div class="w-[32%]">
        <img src="/img/proyectos/antifemina/3-antifemina.jpg" alt="">
    </div>
</div>
...
<div class="flex gap-5 my-6">
    <div class="w-1/2">
        <img class="" src="/img/proyectos/antifemina/4-antifemina.jpg" alt="">
    </div>
    <div class="w-1/2">
        <img class="mt-[14%]" src="/img/proyectos/antifemina/5-antifemina.jpg" alt="">
    </div>
</div>

<div class="max-w-4xl my-6 mx-auto">
    <img class="" src="/img/proyectos/antifemina/6-antifemina.jpg" alt="">
</div>


<div class="flex gap-5 mt-6">
    <div class="w-[42%]">
        <img class="" src="/img/proyectos/antifemina/7-antifemina.jpg" alt="">
    </div>
    <div class="w-[58%]">
        <img class="" src="/img/proyectos/antifemina/8-antifemina.jpg" alt="">
    </div>
</div>

<div class="flex gap-5 mb-6">
    <div class="w-[50%]">
        <img class="" src="/img/proyectos/antifemina/9-antifemina.jpg" alt="">
    </div>
    <div class="w-[50%]">
        <img class="mt-[14%]" src="/img/proyectos/antifemina/10-antifemina.jpg" alt="">
    </div>
</div>
...
<div class="flex">
    <div  class="w-[37.3%]">
        <img src="/img/proyectos/antifemina/12-antifemina.jpg" alt="">
    </div>
    <div  class="w-[37.3%]">
        <img src="/img/proyectos/antifemina/13-antifemina.jpg" alt="">
    </div>
    <div  class="w-[25.4%]">
        <img src="/img/proyectos/antifemina/14-antifemina.jpg" alt="">
    </div>
</div>
