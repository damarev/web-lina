...
<div class="max-w-5xl mx-auto px-6 flex flex-col gap-4 my-8 md:my-16">
	...
	<p>Los <b>talleres de collage</b> son un lugar donde inspirarte, conocer, aprender y compartir.</p>
	<p>Diseño cada sesión como un espacio de exploración artística, destinado a sumergirnos en la riqueza del collage como técnica y como herramienta creativa.</p>
	<p>Estos encuentros nos permiten descubrir la belleza a partir de elementos cotidianos y, gracias a su versatilidad, aprendemos a combinar diferentes piezas y materiales para crear composiciones visuales únicas y llenas de significado.</p>
	<p>Podrás ahondar la mezcla de imágenes, texturas y colores, experimentando con la narrativa visual y la expresión personal, en un ambiente inspirador, en el que desarrollar habilidades de diseño y composición.</p>
</div>
...
<div class="max-w-6xl mx-auto grid grid-cols-1 gap-4 sm:gap-0 sm:grid-cols-2 my-8 md:my-16">
	...
	<div class="sm:order-2 flex flex-col justify-center p-6 md:p-10">
		<p class="quote text-center text-3xl md:text-5xl mb-6 md:mb-10">
			ESTIMULA <span class="italic">tu</span> IMAGINACIÓN
		</p>
	...
	<div class="sm:order-3 flex flex-col justify-center p-6 md:p-10">
		<p class="quote text-center text-3xl md:text-5xl mb-6 md:mb-10">
			AMPLIAR <span class="italic">la</span> MIRADA
		</p>
		<p>El trabajo de recolecta y selección de los elementos que compondrán las obras resultantes es fundamental. Este proceso de toma de decisiones se convierte en un espejo de nuestra identidad.</p>
	</div>

	<img class="sm:order-4" src="/img/talleres/talleres-collage-empresas.jpg" alt="">

	<div class="sm:order-6 flex flex-col justify-center p-6 md:p-10">
		<p class="quote text-center text-3xl md:text-5xl mb-6 md:mb-10">
			<span class="italic">un</span> PUENTE <span class="italic">entre lo</span> CONOCIDO <span class="italic">y lo</span> DESCONOCIDO
		</p>
		<p>Fusionar elementos familiares de maneras inesperadas supone generar un espacio para la investigación, la búsqueda y la sorpresa. Este acto nos invita a cuestionar y a redefinir nuestra comprensión del mundo que nos rodea.</p>
	</div>

	<img class="sm:order-5" src="/img/talleres/talleres-collage-escuelas.jpg" alt="">
