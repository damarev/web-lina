<div class="flex items-center my-10">
	<div class="max-w-xs relative -top-5 pr-5"><img src="img/abrazar_lina_avila.jpg" alt=""></div>
	<h2 class="grow mx-5">
		<p class="quote text-center text-4xl md:text-6xl uppercase">Proyectos</p>
	</h2>
	<div class="max-w-xs relative top-5 pl-5"><img src="img/balada-otono-lina-avila.jpg" alt=""></div>
</div>
...
<div class="flex justify-center my-16 aspect-[15/5]" id="proyects-img">
	<?php foreach ($proyectos as $key => $value): ?>
		<img class="absolute opacity-0 transition-opacity duration-1000 ease-in-out" src="<?php echo $value[1] ?>" alt="<?php echo $value[0] ?>">
	<?php endforeach; ?>
</div>
